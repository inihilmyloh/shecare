      ...
      <ul class="navbar-nav  justify-content-end">
        <li class="nav-item d-flex align-items-center mx-3">
          <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
            ...
            <span class="d-sm-inline d-none">Halo, <?= $_SESSION['name']; ?></span>
          </a>
        </li>
        <!-- <li class="nav-item d-flex align-items-center me-4">
          <a href="?hal=profil" class="btn btn-outline-secondary font-weight-bold m-0 p-2">
            <i class="bi bi-person"></i>
          </a>
        </li> -->
        <li class="nav-item d-flex align-items-center">
          <form method="post">
            <button class="btn btn-outline-danger btn-sm mb-0 me-3" name="btn-logout" type="submit">Logout</button>
          </form>
        </li>
